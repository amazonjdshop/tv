...
class Spider(Spider):
        ...
        try:
            ...
            for soup in soups:
                ...
                for vod in vods:
                    ...
                    pic = 'https://vres.xsefdv.com' + pics[1]['data-original']
    ...
    def detailContent(self, ids):
        ...
        content = '繁华🎉为您介绍剧情📢本资源来源于网络🚓侵权请联系删除👉' + self.extract_middle_text(res,'<div class="detail-desc">','</div>', 0)
